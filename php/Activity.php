            ...
            <div class="col">
                <div class="activity-info">
                    <ul>
                        ...
                        <li> Διαδικασία κλαδέματος, ποτίσματος, συγκομηδής και παραγωγής </li>
                        <li> Φορέστε άνετα ρούχα </li>
                        <li> Θα έχετε την ευκαιρία να δοκιμάστε και να προμηθευτείτε τοπικά κρασία </li>
                    </ul>
                </div>
            </div>
        </div>
      ...
      <div class="row" style="margin-left:5%;margin-top:2%;">
            ...
            <div class="row" style="margin-top:3%;">
                <ul class="list-group list-group-flush activity-about">
                    ...
                    <li class="list-group-item"> <i class="fas fa-info" width="30px;"></i>  &nbsp;&nbsp; Πληροφριές για το κρασί μας μπορείτε να βρείτε <a href="InfoPage.php"> εδώ </a></li>
                </ul>
            </div>
       </div>
